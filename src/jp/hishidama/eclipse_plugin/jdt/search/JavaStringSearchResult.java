...
public class JavaStringSearchResult extends AbstractTextSearchResult implements IFileMatchAdapter, IEditorMatchAdapter {

	private final JavaStringSearchQuery query;

	public JavaStringSearchResult(JavaStringSearchQuery query) {
		this.query = query;
	}
